...
const LeftFloater = () => {
    return (
        <Animation
            delay={0}
            duration={0.4}
            className="fixed bottom-0 left-[40px] w-[40px] z-100 hidden lg:flex flex-col items-center gap-10 after:block after:w-[2px] after:bg-primaryText after:h-[225px] after:mx-auto after:mt-10"
        >
